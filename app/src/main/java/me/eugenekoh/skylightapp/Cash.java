...
public class Cash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flights_cash);
    ...
    private void initCardView(){
        ...
        card_view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                startActivity(new Intent(Cash.this, Options.class));
            }
        });
    }
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        break;
                    case 1:
                        startActivity(new Intent(Cash.this, Chat.class));
                        break;
                    case 2:
                        startActivity(new Intent(Cash.this, Travel.class));
                        break;
                }
